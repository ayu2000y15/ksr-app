...
return [
    ...
    */
    ...
    'options' => [
        ...
        'messages' => [
            'trace' => env('DEBUGBAR_OPTIONS_MESSAGES_TRACE', default: true),                  // Trace the origin of the debug message
            'capture_dumps' => env('DEBUGBAR_OPTIONS_MESSAGES_CAPTURE_DUMPS', true), // Capture laravel `dump();` as message
        ],
        'memory' => [
